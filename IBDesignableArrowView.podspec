#
#  Be sure to run `pod spec lint IBDesignableArrowView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "IBDesignableArrowView"
  s.version      = "0.1"
  s.summary      = "Create customisable arrows in interface builder directly"
...
Create customisable arrows in interface builder directly.
  ...
  s.source_files  = "IBDesignableArrowView/IBDesignableArrowView"
